...
/*
	by adding parentheses '()', the order of operation are changed prioritizing operation inside the parentheses
	pemdas = 1 + (2-3) * (4/5);
	pemdas = 1 + (2-3) * 0.8;
	pemdas = 1 + (-1) * 0.8;
	pemdas = 1 + -0.8;
...
// Increment operator is used to increase the value of variables by 1
// syntax: increment = increment + 1 => increment++
/*
	Two types of increment operators:
	- post increment (x++)
		- increases tje value of x after it has been evaluated
	- pre increment (++x)
...
let z = 3;
// the value of z is at t3 before it was decremented
console.log(z);
let decrement = --z;
// the value of 'z' was dcreased reassigning the value to 2
...
/*
	...
	comparison oeprator
		- are used to compare the values of the left and reight operands
		- return opreands
...
/*
	Equality or Loose equality operator
		...
		the equality performs type coercion, which means it converts the values being compared to a common type before performing  the comparison
*/
...
/*
	Type coercion
		...
		- values are automatically converted from one data type to another data type in order to resolve the operation
*/
...
// the bolean 'false' is associated with the value of 0
let numF = false + 2;
console.log(numF);
